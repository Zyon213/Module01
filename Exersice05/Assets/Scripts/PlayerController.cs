...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (other.gameObject.name == toLeftTrigger)
        {
            isMoveToLeft = false;
            isMoveToRight = true;
        }
        if (other.gameObject.name == toRightTrigger)
        {
            isMoveToLeft = true;
            isMoveToRight = false;
        }
        ...
        if (other.gameObject.name == toUpTrigger)
        {
            toUp = true;
            toDown = false;
        }
        if (other.gameObject.name == toDownTrigger)
        {
            toUp = false;
            toDown = true;
        }
